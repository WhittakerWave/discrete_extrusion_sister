...
with open(f'/project2/fudenber_735/xyan/HBD0715/S114_Run_LE_1104/S114_Sweep_WT_LE_Nipbl_no_sister_6h/WT_trajectory1_bypass_index{bypass_prob_index}_tau{res_time}h.pkl', 'wb') as f:
    pickle.dump({
...
with open(f'/project2/fudenber_735/xyan/HBD0715/S114_Run_LE_1104/S114_Sweep_WT_LE_Nipbl_no_sister_6h/WT_trajectory2_bypass_index{bypass_prob_index}_tau{res_time}h.pkl', 'wb') as f:
    pickle.dump({
