...
filenames = [
    "test_simple_formula_0929/test_case_simple_alpha=10_k=2000_run1_dynamic.pkl",
    "test_simple_formula_0929/test_case_simple_alpha=10_k=2000_run2_dynamic.pkl",
    "test_simple_formula_0929/test_case_simple_alpha=10_k=2000_run3_dynamic.pkl",
]
...
def plot_simulation_with_long_time(filenames, labels=None):
    ...
    # ---- Long-time limit ----
    plt.axhline(A, color='k', linestyle='--', linewidth=2.5, label=f"Theoretical limit for non-dynamical LEFs ~ {A:.1f}")

    # ---- Formatting ----
    plt.title("Simulation vs Mean Field Limit\n[$M$=500, $N$=32000, $k=2000$, $\\alpha=10$]", fontsize=20)
