...
dN_100s_sister1 = load_translocator("CTCF_dynamics_0912/dN_CTCF100s_sister1.pkl")['sister'][-1]
dN_100s_sister2 = load_translocator("CTCF_dynamics_0912/dN_CTCF100s_sister2.pkl")['sister'][-1]
dN_1000s_sister1 = load_translocator("CTCF_dynamics_0912/dN_CTCF1000s_sister1.pkl")['sister'][-1]
dN_1000s_sister2 = load_translocator("CTCF_dynamics_0912/dN_CTCF1000s_sister2.pkl")['sister'][-1]


static_diff = 2.5*(dN_static_sister2 - dN_static_sister1)
s100_diff = 2.5*(dN_100s_sister2 - dN_100s_sister1)
s1000_diff = 2.5*(dN_1000s_sister2 - dN_1000s_sister1)
