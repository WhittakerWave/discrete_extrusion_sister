...
filenames = [
    "test_simple_formula_0926/test_case_simple_alpha=10_k=200_run1.pkl",
    "test_simple_formula_0926/test_case_simple_alpha=10_k=200_run2.pkl",
    "test_simple_formula_0926/test_case_simple_alpha=10_k=200_run3.pkl",
]
...
def plot_simulation_with_long_time(filenames, labels=None):
    ...
    # ---- Formatting ----
    plt.title("Simulation vs Mean Field Limit\n[$M$=500, $N$=32000, $k=200$, $\\alpha=10$]", fontsize=20)
