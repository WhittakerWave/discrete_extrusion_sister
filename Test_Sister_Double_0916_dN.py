...
ctcf_left_positions = np.load('ctcf_left_positions_full.npy')
ctcf_right_positions = np.load('ctcf_right_positions_full.npy')
...
with open('dN_trajectory2.pkl', 'wb') as f:
    pickle.dump({
