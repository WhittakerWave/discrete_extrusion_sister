...
def run_simulation(config, residence_time, sister_damping):
    ...
    # Calculate metrics
    total_bound_ext = (df_since_0h['R'][index] + df_since_0h['RN'][index] + 
                       df_since_0h['RP'][index] + df_since_0h['RPW'][index])
    ...
    sister_RAD21_time_1h = calculate_sister_RAD21_bound_time(
    ...
    rates = {
        'R_free_to_RN': paras_dict_ext_coh_local['Kext_R_free_RN']*df_since_0h['N'][index],
        'RPW_R_free': paras_dict_ext_coh_local['Kext_RPW_R_free'],
        'RN_R': paras_dict_ext_coh_local['Kext_RN_R'],
        'R_RN': paras_dict_ext_coh_local['Kext_R_RN']*df_since_0h['N'][index],
        'R_RP': paras_dict_ext_coh_local['Kext_R_RP']*df_since_0h['P'][index],
        'RP_R': paras_dict_ext_coh_local['Kext_RP_R'],
        'RP_RPW': paras_dict_ext_coh_local['Kext_RP_RPW']*df_since_0h['W'][index],
...
def main():
    ...
    # Load configuration
    config = load_config('network_parameters_dNd80_1h_G2.json')
