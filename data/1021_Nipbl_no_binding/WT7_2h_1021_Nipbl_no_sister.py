...
def run_simulation(config, residence_time, sister_damping):
    ...
    Model_ext_coh_WT = r_ext_coh.simulate(0, 3600*7, 3600*7)
    ...
    # Calculate LEF_sep and velocity at 3.5h
    ...
    LEF_sep_7_2h = int(LATTICE_SIZE * extC_bound_frac / (extC_value / 2))
    ...
    output_params["LEF_separation"] = LEF_sep_7_2h
...
def main():
    ...
    # Load configuration
    config = load_config('network_parameters_WT7_2h.json')
