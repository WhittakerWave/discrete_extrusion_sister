...
### 
### This script generates the parameters for dSororin simulations with rates from WT 9h
...
# Define the ranges 
RESIDENCE_TIMES = [4, 6, 8, 10, 12, 14, 16, 18, 20, 25, 30, 1000]        # in hours
...
def main():
    ...
    # Load configuration
    config = load_config('network_parameters_dS.json')
