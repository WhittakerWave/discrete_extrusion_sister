...
def compute_cluster_size_distribution(sister_trajectory):
    ...
    mask = (final_positions != -1) 
    counts = np.bincount(final_positions[mask])
...
filenames = [
    'CTCF_dynamics_0914/dW_CTCF_Static_damp1_sister1.pkl',
    'CTCF_dynamics_0914/dN_CTCF_Static_damp1_sister1.pkl',
    'CTCF_dynamics_0914/WT_CTCF_Static_damp1_sister1.pkl'
]
labels = ['dW99%', 'dN75%', 'WT']
