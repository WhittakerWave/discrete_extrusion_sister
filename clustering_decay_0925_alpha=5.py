...
def plot_unique_positions_combined(filenames, labels=None, t=None, rho=None, alpha=None, M=None):
    ...
    if t is not None and rho is not None and alpha is not None and M is not None:
        ...
        plt.plot(t_late, M - N_late, 'r--', linewidth=2.5, label=r"Late-time Scaling: $M - \sqrt{2Mt/(Nα)}$")
...
filenames = [
    "test_simple_formula_0925/test_case_simple_alpha=5_run1.pkl",
    "test_simple_formula_0925/test_case_simple_alpha=5_run2.pkl",
    "test_simple_formula_0925/test_case_simple_alpha=5_run3.pkl"
]
