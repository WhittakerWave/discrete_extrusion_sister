...
filenames = [
    "test_simple_formula_0929/test_case_simple_alpha=10_k=500_run1_dynamic.pkl",
    "test_simple_formula_0929/test_case_simple_alpha=10_k=500_run2_dynamic.pkl",
    "test_simple_formula_0929/test_case_simple_alpha=10_k=500_run3_dynamic.pkl",
]
...
def plot_simulation_with_long_time(filenames, labels=None):
    ...
    # ---- Long-time limit ----
    plt.axhline(A, color='k', linestyle='--', linewidth=2.5, label=f"Theoretical limit for non-dynamics ~ {A:.1f}")
