...
dW_static_sister1 = load_translocator("CTCF_dynamics_0914_tau28800/dW_CTCF_Static_damp1_sister1.pkl")['sister'][-1]
dW_static_sister2 = load_translocator("CTCF_dynamics_0914_tau28800/dW_CTCF_Static_damp1_sister2.pkl")['sister'][-1]
dW_100s_sister1 = load_translocator("CTCF_dynamics_0914_tau28800/dW_CTCF100s_damp1_sister1.pkl")['sister'][-1]
dW_100s_sister2 = load_translocator("CTCF_dynamics_0914_tau28800/dW_CTCF100s_damp1_sister2.pkl")['sister'][-1]
dW_1000s_sister1 = load_translocator("CTCF_dynamics_0914_tau28800/dW_CTCF1000s_damp1_sister1.pkl")['sister'][-1]
dW_1000s_sister2 = load_translocator("CTCF_dynamics_0914_tau28800/dW_CTCF1000s_damp1_sister2.pkl")['sister'][-1]
