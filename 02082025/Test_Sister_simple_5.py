...
with open("extrusion_dict_Simple_5.json", 'r') as dict_file:
...
translocator1 = Translocator_Sister(BaseExtruder_Sister,
                    ...
                    initial_sister_positions = np.array([2500, 3500]),
                    **paramdict)

# translocator1.run(10000)
translocator1.run_trajectory_one_sister(steps = 5000, prune_unbound_LEFs=True, track_sisters=True, sample_interval=1)
