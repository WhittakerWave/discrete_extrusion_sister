...
with open("data/new_dict/alpha500_tau15h/extrusion_dict_RN_RB_RP_RW_HBD_S1h_alpha500_tau15h.json", 'r') as dict_file:
        paramdict_S1h = json.load(dict_file)
    
monomers_per_replica = paramdict_S1h['monomers_per_replica'] 
sites_per_monomer = paramdict_S1h['sites_per_monomer']
num_of_sisters = paramdict_S1h['num_of_sisters']
...
LEF_off_rate = paramdict_S1h['LEF_off_rate']
CTCF_facestall = paramdict_S1h['CTCF_facestall']
...
with open('S2h_trajectory1.pkl', 'wb') as f:
    pickle.dump({
...
with open('S2h_trajectory2.pkl', 'wb') as f:
    pickle.dump({
